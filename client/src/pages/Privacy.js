		...
		<main>
			...
			<div className='md:w-2/3 md:mx-auto xl:w-1/3 xl:mx-auto'>
				...
				<div className='px-4'>
					...
					<p className='font-sora text-sm my-4'>
						We use this information to create your account and to allow you to
						log in to Linkify.
					</p>
					<p className='font-sora text-sm mb-6'>
						In addition, you may choose to upload photos to Linkify. These
						photos will be stored in a secure cloud-based media management
						service.
					</p>
				</div>
				<div className='px-4'>
				...
				<div className='px-4'>
					...
					<p className='font-sora text-sm my-4'>
						We may also share non-personal, aggregated data with third parties
				...
				<div className='px-4'>
					...
					<p className='font-sora text-sm my-4'>
						We may update this privacy notice from time to time. We will post
						any changes on this page, and we encourage you to review this
						privacy notice periodically.
					</p>
				</div>
				<div className='px-4'>
