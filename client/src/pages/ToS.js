		...
		<main>
			...
			<div className='px-4'>
				...
				<p className='font-sora text-sm my-4'>
					...
					software, is the property of Linkify or its licensors and is protected
			...
			<div className='px-4'>
				<h1 className='font-unbounded text-lg mt-6'>Limitation of Liability</h1>
				<p className='font-sora text-sm my-4'>
			...
			<div className='px-4'>
				<h1 className='font-unbounded text-lg mt-6'>Changes to these Terms</h1>
				<p className='font-sora text-sm my-4'>
					We may revise these terms of service from time to time. The most
					current version of the terms will govern our relationship with you. We
